  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.sizesOuterContainer}>
        {sizes.map((size) => (
          <Pressable
            ...
            style={[
              styles.sizesInnerContainer,
              {
                backgroundColor:
                  selectedState === size ? '#D90429' : '#ccd0d9',
              },
            ]}
          >
            <Text
              style={[
                styles.sizesText,
                {
                  color: selectedState === size ? '#EDF2F4' : '#2B2D42',
                },
              ]}
            >
              {size}
      ...
      <Text style={styles.descText}>
        ...
        ipsam ut necessitatibus voluptatum praesentium, porro, modi
        perspiciatis consectetur ratione debitis dolores, provident veritatis
        delectus est unde perferendis quo deserunt sint?
      </Text>
